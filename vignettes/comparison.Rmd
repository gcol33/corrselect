...
| **Handles multicollinearity?** | ⚠️ Partially | ✅ Yes |
...
| **Multicollinearity** | ⚠️ Handles via shrinkage | ✅ Removes via pruning |
| **Interpretability** | ⚠️ Coefficients shrunk (biased) | ✅ Unbiased coefficients |
