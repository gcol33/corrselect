...
# Benchmark (extended range to show scaling behavior)
p_values <- c(10, 20, 50, 100, 200, 300)
...
# Mark where exact mode becomes impractical
abline(v = 100, lty = 2, col = "gray50")
text(100, ylim[2] * 0.5, "Exact mode limit", pos = 4, col = "gray30")
```

**Key insight**: Exact mode shows exponential scaling and becomes impractical beyond p ≈ 100. Greedy mode scales approximately linearly and remains efficient even for p = 300, making it suitable for high-dimensional applications.
