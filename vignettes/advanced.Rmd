...
**Key insight**: Both exact and greedy modes scale efficiently for typical correlation structures. For this moderately correlated dataset (ρ = 0.5^|i-j|), both algorithms remain practical up to p = 300. The greedy mode offers a speed advantage, while exact mode provides guaranteed optimality.
