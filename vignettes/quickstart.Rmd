...
Let's use the `bioclim_example` dataset with the 19 WorldClim bioclimatic variables:
...
Many of these variables are redundant. Let's remove variables that correlate > 0.7:
...
**Result**: Reduced from 19 → ~8 variables, all with pairwise correlations ≤ 0.7.
