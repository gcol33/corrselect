...
vs. actual results - Threshold and method used (e.g., `"els"` or
`"bron-kerbosch"`) - R and operating system version - Toolchain info if
relevant (e.g., Rtools on Windows)

------------------------------------------------------------------------

By contributing to corrselect, you agree that your code is released
